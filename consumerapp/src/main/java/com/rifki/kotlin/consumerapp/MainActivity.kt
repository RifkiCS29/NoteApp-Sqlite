package com.rifki.kotlin.consumerapp
...
import com.rifki.kotlin.consumerapp.adapter.NoteAdapter
import com.rifki.kotlin.consumerapp.db.DatabaseContract.NoteColumns.Companion.CONTENT_URI
//import com.rifki.kotlin.consumerapp.db.NoteHelper
import com.rifki.kotlin.consumerapp.entity.Note
import com.rifki.kotlin.consumerapp.helper.MappingHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* digantikan dengan ContentResolver
        ...
        if (data != null) {
            when (requestCode) {
                ...
                NoteAddUpdateActivity.REQUEST_UPDATE ->
                    when (resultCode) {
                        // Akan dipanggil jika result codenya UPDATE dan Semua data di load kembali dari awal
